...
public:
    ...
    static long long kthSmallestProduct(vector<int>& nums1, vector<int>& nums2, long long k) {
        ...
        vector<int> A0(nums1.begin(), nums1.begin()+a0);   
        vector<int> A1(nums1.begin()+a0, nums1.end());     
        vector<int> B0(nums2.begin(), nums2.begin()+b0);   
        vector<int> B1(nums2.begin()+b0, nums2.end());    
